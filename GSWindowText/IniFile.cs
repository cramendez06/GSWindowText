...
namespace GSWindowText
{
    ...
    public class IniFile
    {
        ...
        /// Program title：IniFile
        /// Overview：IniFile Reader/Writer
        ///
        ...
        public IniFile(string p_filepath) {
            File.Create(p_filepath).Dispose();
            m_sections = new Hashtable(StringComparer.InvariantCultureIgnoreCase);
        }
        ...
        {
            // Get file info
            FileInfo myFile = new FileInfo(sFileName);
        ...
        //Returns All KeyValues in a certain section
        public object GetAllKeys(string sSection)
        {
            IniSection s = GetSection(sSection);
            string[] w_allKeys = null;

            if (s != null)
            {
                int w_allKeysCnt = s.KeyAll.Count;
                ICollection w_col = s.KeyAll;

                w_allKeys = new string[w_allKeysCnt];

                w_col.CopyTo(w_allKeys, 0);
            }
        ...
        public class IniSection
        {
            ...
            //Returns all the key values in a section
            ...
            public System.Collections.ICollection KeyAll
            {
                get { return m_keys.Keys; }
            }
